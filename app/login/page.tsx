...
import { signInWithEmailOrUsername } from "./actions"
  ...
  const handleSocialAuth = async (provider: "google" | "apple" | "github") => {
    try {
      ...
      const { error } = await supabase.auth.signInWithOAuth({
        ...
        options: {
          redirectTo: process.env.NEXT_PUBLIC_DEV_SUPABASE_REDIRECT_URL || `${window.location.origin}/predictions`,
        },
      })
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-20">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-foreground mb-2">Welcome back to Cagebot</h1>
            <p className="text-muted-foreground">Sign in to access exclusive UFC predictions</p>
          </div>
